...
public enum ResponseCode {
    ...
    RECIPE_INPUT_IS_INVALID("AI-4003", RECIPE_INPUT_IS_INVALID_MESSAGE, RECIPE_INPUT_IS_INVALID_USER_MESSAGE),
    ...
    TIMEOUT_EXCEPTION("AI-5003", TIMEOUT_EXCEPTION_MESSAGE, TIMEOUT_EXCEPTION_USER_MESSAGE);
